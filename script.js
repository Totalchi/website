...
const translations = {
  nl: {
    nav_why:       'Waarom',
    nav_about:     'Over ons',
    nav_features:  'Wat wij bieden',
    nav_pricing:   'Prijzen',
    nav_contact:   'Contact',
    hero_title:    'Rust voor uzelf en uw nabestaanden',
    hero_text:     'Regel eenvoudig uw digitale nalatenschap: social media, foto\'s, documenten en meer. Alles veilig opgeslagen en overdraagbaar wanneer het nodig is.',
    hero_cta:      'Begin gratis scan',
    hero_note:     '* AVG-proof: uw privacy is gewaarborgd volgens GDPR.',
    why_title:     'Waarom Digitale Zekerheid?',
    why_text:      'In ons digitale tijdperk bevatten uw online accounts, foto\'s, documenten en berichten waardevolle herinneringen en belangrijke informatie. Zonder goede regeling raken deze data na overlijden of onverwachte gebeurtenissen vaak ontoegankelijk of verspreid. Met onze oplossing zorgt u ervoor dat uw dierbaren precies weten hoe ze uw digitale nalatenschap kunnen beheren, delen of bewaren. Zo voorkomt u onzekerheid en bespaart u uw familie tijd, zorgen en kosten.',
    about_title:   'Over NexLegacy',
    about_text:    'Als gezinsexperts, digitale specialisten en juristen helpen wij particulieren hun online erfenis te beheren. Wij zorgen dat uw dierbare herinneringen en belangrijke bestanden beschikbaar blijven voor de mensen die u lief zijn.',
    features_title:'Wat wij bieden',
    plan1_title:   'Basis',
    plan1_1:       'Wensendashboard',
    plan1_2:       'Accountscan standaard',
    plan1_3:       'E-mailondersteuning',
    plan2_title:   'Plus',
    plan2_1:       'Alles in Basis',
    plan2_2:       'Premium opslagruimte',
    plan2_3:       'Prioriteitssupport',
    plan3_title:   'Premium',
    plan3_1:       'Persoonlijk accountmanager',
    plan3_2:       'Jaarlijkse check‑up',
    plan3_3:       'Extra opslagmogelijkheden',
    pricing_title: 'Onze pakketten',
    contact_title: 'Vragen? Wij helpen graag',
    contact_name:  'Naam*',
    contact_email: 'E‑mail*',
    contact_phone: 'Telefoon (optioneel)',
    contact_message:'Bericht',
    contact_send:  'Verstuur',
    footer_text:   '© 2025 NexLegacy. Alle rechten voorbehouden.'
  },
  en: {
    nav_why:       'Why',
    nav_about:     'About us',
